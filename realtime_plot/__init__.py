...
class RealtimePlotter(object):
    ...
    def __init__(self, ylims, size=100, phaselims=None, show_yvals=False,
        ...
        self.writer = animation.FFMpegWriter(fps=15, metadata=metadata)
        self.time =time.time()
    ...
    def start(self):
        ...
        ani.save("{} at{}.mp4".format(self.window_name,  time.strftime("%H_%M_%S", time.gmtime())), writer=self.writer)
